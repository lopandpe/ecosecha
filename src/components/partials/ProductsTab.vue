        ...
        >
          <v-card flat>
            <v-card-text class="d-flex flex-wrap justify-center">
              <Product v-for="product in item.content" :key="product.id" :name="product.nombre" :price="product.precio" :image="product.imagen" :id="product.id" :from="product.origen" :type="item.tab"  @addedProduct="updateBasket"/>
